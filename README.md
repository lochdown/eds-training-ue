...
## Environments
- Preview: https://main--eds-training-ue--lochdown.aem.page/
- Live: https://main--eds-training-ue--lochdown.aem.live/
...
1. Open the `eds-training-ue` directory in your favorite IDE and start coding :)
